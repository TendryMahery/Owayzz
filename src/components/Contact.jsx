    ...
    return(
        <div id="contact">
            <div className="bg-gradient-to-br from-slate-700 to-purple-500 min-h-screen md:h-screen w-full">
                <div className="md:pt-20 0 pt-6 sm:px-40 md:px-8 p-2">
                    <div className="text-center text-white mb-4">
                        <h1 className="text-3xl sm:text-6xl font-bold">Contact</h1>
                            ...
                            <div className="md:flex">
                                ...
                                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                                    <form class="space-y-1" action="#" >
                                        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Contact</h5>
                                        ...
                                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Message</label>
                                            <textarea  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  required/>
                                        </div>
            ...
            <footer class="bg-white dark:bg-gray-900">
                    ...
                    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="#" class=" hover:underline">Vanilla Pay LT Giruliug. 10-201, LT 12112 Vilnius</a>
                                </li>
                                
                                <li class="mb-4 flex">
                                    <FaPhone/>
                                    <a href="#" class="hover:underline">+37066699115</a>
                                </li>
                                <li class="mb-4 flex">
                                    <FaVoicemail/>
                                    <a href="#" class="hover:underline">Email: contact@vanilla.travel</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">PrivacyPolicy</a>
                                </li>
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">TermsConditions</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium flex space-x-8">
                    ...
                    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">TendryMahery</a>. email: rafanomezanatendrymahery@mail.com, n°: 0349664223 ou 0327585867
                        </span>
